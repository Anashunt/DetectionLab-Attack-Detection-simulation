...
# The objective of this lab was not simply to deploy the environment, but to use it as a practical training platform for \*\*attack simulation, security monitoring, log analysis, network analysis, detection engineering, and incident investigation\*\*.
...
# Examples of investigated telemetry include:
